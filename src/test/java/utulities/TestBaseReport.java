...
//BU eski güncelini tekrar kontrol etmek lazım bu şekilde de çalışır ama
public class TestBaseReport {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "testerIsmi");
        extentHtmlReporter.config().setDocumentTitle("Test");
